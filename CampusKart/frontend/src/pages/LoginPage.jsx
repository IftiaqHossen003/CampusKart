...
function LoginPage() {
  ...
  return (
    <section className="mx-auto max-w-lg rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      <h1 className="text-2xl font-semibold text-primary">Sign in to CampusKart</h1>
      <p className="mt-1 text-sm text-muted">Use your backend account credentials to continue.</p>
